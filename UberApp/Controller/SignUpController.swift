...
class SignUpController: UIViewController {
    ...
    private lazy var accountTypeContainerView: UIView = {
        let view = UIView().inputContainerView(image: UIImage(named: "ic_account_box_white_2x")!,
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        button.addTarget(SignUpController.self, action: #selector(handleShowLogin), for: .touchUpInside)
    ...
    @objc func handleSignUp() {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (result, error) in
            ...
            let values = ["email": email,
                          "fullname": fullname, "accountType": accountTypeIndex] as [String: Any]
